...
public class DailyReward : MonoBehaviour
{
    ...
    public List<Button> getreward_btns;
    private int current;

    private void Start()
    {
        foreach (var t in getreward_btns)
        {
            t.interactable = false;
        }
        Debug.Log("cd"+PlayerPrefs.GetInt("ConsecutiveDays"));
    ...
    void GrantDailyReward(int consecutiveDays)
    {
        ...
        Debug.Log("You've earned a daily reward of " + rewardAmount + " coins for logging in " + consecutiveDays +
                  " consecutive days!");
