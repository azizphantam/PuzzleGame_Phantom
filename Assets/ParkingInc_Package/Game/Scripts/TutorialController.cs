...
public class TutorialController : MonoBehaviour
{
    ...
    {
        Vector2 forwardScreenPosition = CameraController.MainCamera.WorldToScreenPoint(steps[CurrentStepId].movable.ForwardPosition + Vector3.up);
        Vector2 backScreenPosition = CameraController.MainCamera.WorldToScreenPoint(steps[CurrentStepId].movable.BackPosition + Vector3.up);
    ...
    {
        Vector2 normalizedScreenPosition = new Vector2(screenPosition.x / CameraController.MainCamera.pixelWidth, screenPosition.y / CameraController.MainCamera.pixelHeight);
